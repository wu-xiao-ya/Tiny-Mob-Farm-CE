...
public class BlockMobFarm extends Block {
	...
	public BlockMobFarm(EnumMobFarm mobFarmData, boolean mechanical) {
		super(mobFarmData.getMaterial());
		this.setHardness(mobFarmData.getHardness());
		this.setHarvestLevel("pickaxe", 2);
		this.setResistance(300);
		
		this.setRegistryName(mobFarmData.getRegistryName(mechanical));
	...
	public Consumer<List<String>> getTooltipBuilder() {
		return tooltip -> this.mobFarmData.addTooltip(tooltip, this.mechanical);
	}
	...
	public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
		...
		if (tileEntity instanceof TileEntityMobFarm) {
			...
			tileEntityMobFarm.setMechanical(this.mechanical);
